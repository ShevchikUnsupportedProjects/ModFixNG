...
public class CloseInventory extends Packet101CloseWindow {
	...
	public void handle(Connection paramConnection) {
		if (paramConnection instanceof PlayerConnection) {
			...
			CloseInventoryPacketCloseInventoryEvent event = new CloseInventoryPacketCloseInventoryEvent(cplayer, a);
